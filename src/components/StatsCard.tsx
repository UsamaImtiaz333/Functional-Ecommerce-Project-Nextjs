...
import { FaStore, FaDollarSign, FaGift, FaMoneyBill } from "react-icons/fa";
const StatsCard = () => {
  return (
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
        ...
        <div className="group flex flex-col items-center justify-center text-center rounded-md border border-gray-200 shadow-sm p-6 cursor-pointer transition-all duration-300 hover:bg-[#DB4444] hover:text-white">
          <div className="w-16 h-16 flex items-center justify-center rounded-full bg-gray-100 group-hover:bg-white mb-4 transition-colors duration-300">
            <FaStore size={28} className="text-black group-hover:text-[#DB4444]" />
          </div>
        ...
        <div className="group flex flex-col items-center justify-center text-center rounded-md border border-gray-200 shadow-sm p-6 cursor-pointer transition-all duration-300 hover:bg-[#DB4444] hover:text-white">
          <div className="w-16 h-16 flex items-center justify-center rounded-full bg-gray-100 group-hover:bg-white mb-4 transition-colors duration-300">
            <FaDollarSign size={28} className="text-black group-hover:text-[#DB4444]" />
          </div>
        ...
        <div className="group flex flex-col items-center justify-center text-center rounded-md border border-gray-200 shadow-sm p-6 cursor-pointer transition-all duration-300 hover:bg-[#DB4444] hover:text-white">
          <div className="w-16 h-16 flex items-center justify-center rounded-full bg-gray-100 group-hover:bg-white mb-4 transition-colors duration-300">
            <FaGift size={28} className="text-black group-hover:text-[#DB4444]" />
          </div>
        ...
        <div className="group flex flex-col items-center justify-center text-center rounded-md border border-gray-200 shadow-sm p-6 cursor-pointer transition-all duration-300 hover:bg-[#DB4444] hover:text-white">
          <div className="w-16 h-16 flex items-center justify-center rounded-full bg-gray-100 group-hover:bg-white mb-4 transition-colors duration-300">
            <FaMoneyBill size={28} className="text-black group-hover:text-[#DB4444]" />
          </div>
